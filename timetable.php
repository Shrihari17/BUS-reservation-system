...
<body>
                ...
                <table border="0" class="busdataarea" cellpadding="0" cellspacing="20" style="width:100%; margin: 0; float:none; padding: 20px 10px;">
                    ...
                    if($rows>0){
                        while($data = mysqli_fetch_object($run)){
                            ...
                            echo "<td><a href='edit_timetable.php?id=".$data->route_id."'>Edit</a> | <a href='delete_timetable.php?id=".$data->route_id."'>Delete</a></td>";
                            echo "</tr>";
                        }
                    }
                    else{
    ...
    <form method="post" action="delete_timetable.php">
    <!-- Other form fields -->
    <input type="hidden" name="route_id" value="<?php echo $data->route_id; ?>">
