...
CREATE TABLE bookings (
    ...
    journey_date DATE NOT NULL,
    booking_date DATE NOT NULL,
    number_of_seats INT(6) NOT NULL,
    route_rent DECIMAL(10, 2) NOT NULL,
    ...
    current_phone_no VARCHAR(20) NOT NULL,
    bus_type VARCHAR(50) NOT NULL,
...
CREATE PROCEDURE `insert_booking` (
    IN p_route_id INT(6),
    IN p_seat_number VARCHAR(255),
    IN p_journey_date DATE,
    IN p_booking_date DATE,
    IN p_number_of_seats INT(6),
    IN p_route_rent DECIMAL(10, 2),
    IN p_total_rent DECIMAL(10, 2),
    IN p_customer_id INT(6),
    IN p_customer_name VARCHAR(255),
    IN p_email VARCHAR(255),
    IN p_address VARCHAR(255),
    IN p_contact_no VARCHAR(20),
    IN p_payment_method VARCHAR(20),
    IN p_current_phone_no VARCHAR(20),
